...
class Scripture
{
   ...
   public Scripture()
   {
      _scriptureVerse = "And now, behold, my beloved brethren, this is the way; and " +
    "there is none other way nor name given under heaven whereby man can be saved in the " + 
    "  kingdom of God. And now, behold, this is the doctrine of Christ, and the only " + 
    "  and true doctrine of the Father, and of the Son, and of the Holy Ghost, which " +
   ...
   {
      ScriptureReference scriptureReference = new ScriptureReference("21");
